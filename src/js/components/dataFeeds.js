...
var feeds = {
  ...
  'rateCards': [ 'data/RateCardBillRateCollection.json', '/sap/opu/odata/sap/ZUX_PCT_SRV/RateCardCollection?$filter=Office eq \'{param1}\' and ToCurrency eq \'{param2}\'&$format=json' ],
